...
const Specialized = () => {
  ...
  return (
      ...
      <Wrapper>
        <div>
          ...
          <p className="mt-5 text-xl text-slate-600 max-w-screen-sm">
            After completing the first three quarters, the participants will select one or more
        ...
        <div className="mt-10 flex flex-col-reverse lg:flex-row gap-x-4 gap-y-8">
          ...
          <div className="basis-8/12 sticky top-28 self-start shadow-xl rounded-xl border-teal-300 px-8 py-8">
            <h4 className="text-lg text-primary font-bold">Specialized Program</h4>
    ...
    {/* CONTENT RIGHT */}
          <div className="basis-4/12 px-4 space-y-8 py-6 ">
            {
            ...
            <div onClick={()=>setSelectedItem(item.slug)} key={item.slug} className="flex gap-x-4 items-center cursor-pointer">
              <div className="flex-shrink-0">
                ...
                <Image src={"/assessts/images/web3.png"} width={160} height={96} alt={item.header} className=" object-cover rounded-md"/>
              </div>
